...
if("FALSE" STREQUAL "TRUE")
  set(common_utilities_SOURCE_PREFIX /home/letrend/workspace/roboy_middleware/src/common_utilities)
  set(common_utilities_DEVEL_PREFIX /home/letrend/workspace/roboy_middleware/src/roboy_powerlink/openPowerLink/devel)
  ...
  set(common_utilities_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'common_utilities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
