// mn_soc_host_de10_nano_soc_hps_0.v

// This file was auto-generated from altera_hps_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.0 200 at 2018.01.25.20:12:00

`timescale 1 ps / 1 ps
module mn_soc_host_de10_nano_soc_hps_0 #(
		...
		output wire [7:0]  emac1_phy_txd_o,           //               emac1.phy_txd_o
		...
		inout  wire        hps_io_gpio_inst_LOANIO20, //                    .hps_io_gpio_inst_LOANIO20
		inout  wire        hps_io_gpio_inst_LOANIO21  //                    .hps_io_gpio_inst_LOANIO21
	);
	...
	mn_soc_host_de10_nano_soc_hps_0_fpga_interfaces fpga_interfaces (
		...
		.emac_ptp_ref_clk        (emac_ptp_ref_clk),                       //  emac_ptp_ref_clock.clk
		.emac1_phy_txd_o         (emac1_phy_txd_o),                        //               emac1.phy_txd_o
		.emac1_phy_txen_o        (emac1_phy_txen_o),                       //                    .phy_txen_o
		.emac1_phy_txer_o        (emac1_phy_txer_o),                       //                    .phy_txer_o
		.emac1_phy_rxdv_i        (emac1_phy_rxdv_i),                       //                    .phy_rxdv_i
		.emac1_phy_rxer_i        (emac1_phy_rxer_i),                       //                    .phy_rxer_i
		.emac1_phy_rxd_i         (emac1_phy_rxd_i),                        //                    .phy_rxd_i
		.emac1_phy_col_i         (emac1_phy_col_i),                        //                    .phy_col_i
		.emac1_phy_crs_i         (emac1_phy_crs_i),                        //                    .phy_crs_i
		.emac1_gmii_mdo_o        (emac1_gmii_mdo_o),                       //                    .gmii_mdo_o
		.emac1_gmii_mdo_o_e      (emac1_gmii_mdo_o_e),                     //                    .gmii_mdo_o_e
		.emac1_gmii_mdi_i        (emac1_gmii_mdi_i),                       //                    .gmii_mdi_i
		.emac1_ptp_pps_o         (emac1_ptp_pps_o),                        //                    .ptp_pps_o
		.emac1_ptp_aux_ts_trig_i (emac1_ptp_aux_ts_trig_i),                //                    .ptp_aux_ts_trig_i
		.emac1_gmii_mdc_o        (emac1_gmii_mdc_o),                       //        emac1_md_clk.clk
		.emac1_clk_rx_i          (emac1_clk_rx_i),                         //     emac1_rx_clk_in.clk
		.emac1_clk_tx_i          (emac1_clk_tx_i),                         //     emac1_tx_clk_in.clk
		.emac1_phy_txclk_o       (emac1_phy_txclk_o),                      //       emac1_gtx_clk.clk
		.emac1_rst_clk_tx_n_o    (emac1_rst_clk_tx_n_o),                   //      emac1_tx_reset.reset_n
		.emac1_rst_clk_rx_n_o    (emac1_rst_clk_rx_n_o)                    //      emac1_rx_reset.reset_n
	);

	mn_soc_host_de10_nano_soc_hps_0_hps_io hps_io (
		...
		.hps_io_gpio_inst_LOANIO20 (hps_io_gpio_inst_LOANIO20),              //            .hps_io_gpio_inst_LOANIO20
		.hps_io_gpio_inst_LOANIO21 (hps_io_gpio_inst_LOANIO21)               //            .hps_io_gpio_inst_LOANIO21
	);
